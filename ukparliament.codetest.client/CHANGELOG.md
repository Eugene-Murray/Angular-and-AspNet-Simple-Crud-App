...
- Create Angular project with ng: `ng new ukparliament.codetest.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`ukparliament.codetest.client.esproj`).
